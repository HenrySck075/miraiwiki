...
// Function to convert a hex color to an RGB object
  ...
  for (const [colorName, shades] of Object.entries(tailwindColors)) {
    for (const [shade, tailwindHex] of Object.entries(shades)) {
      ...
      const distance = Math.sqrt(
        Math.pow(targetRgb.r - tailwindRgb.r, 2) +
        Math.pow(targetRgb.g - tailwindRgb.g, 2) +
        Math.pow(targetRgb.b - tailwindRgb.b, 2)
      );
