<template>
  <div class="p-4">
    ...
    <br>
    MiraiWiki is a reimplementation of <ULink to="https://breezewiki.com">BreezeWiki</ULink>, which 
    ...
    <p class="text-green-600">&gt;attempting to go to a wiki's forum page with miraiwiki works, which is ironic and unbased honestly —Rattledash</p>
    <Footer></Footer>
  </div>
</template>
